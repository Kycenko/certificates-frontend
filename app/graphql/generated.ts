...
export type GetAllGroupsQuery = { __typename?: 'Query', getAllGroups: Array<{ __typename?: 'GroupModel', id: string, title: string, course?: { __typename?: 'CourseModel', id: string, number: number, departmentId: string } | null }> };
