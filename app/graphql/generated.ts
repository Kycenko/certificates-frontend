...
export type GetPhysicalEducationByTitleQuery = {
	__typename?: 'Query'
	getPhysicalEducationByTitle: {
		__typename?: 'PhysicalEducationModel'
		id: string
		title: string
	}
...
export const UpdatePhysicalEducationDocument = gql`
	mutation UpdatePhysicalEducation(
		$data: PhysicalEducationInput!
		$updatePhysicalEducationId: String!
	) {
 ...
 * });
 */
export function useGetPhysicalEducationByTitleQuery(
	baseOptions: Apollo.QueryHookOptions<
		GetPhysicalEducationByTitleQuery,
		GetPhysicalEducationByTitleQueryVariables
	> &
		(
			| { variables: GetPhysicalEducationByTitleQueryVariables; skip?: boolean }
			| { skip: boolean }
		)
) {
	const options = { ...defaultOptions, ...baseOptions }
	return Apollo.useQuery<
		GetPhysicalEducationByTitleQuery,
		GetPhysicalEducationByTitleQueryVariables
	>(GetPhysicalEducationByTitleDocument, options)
}
export function useGetPhysicalEducationByTitleLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		GetPhysicalEducationByTitleQuery,
		GetPhysicalEducationByTitleQueryVariables
	>
...
export function useGetPhysicalEducationByTitleSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
		| Apollo.SuspenseQueryHookOptions<
				GetPhysicalEducationByTitleQuery,
...
export type GetPhysicalEducationByTitleQueryHookResult = ReturnType<
	typeof useGetPhysicalEducationByTitleQuery
>
export type GetPhysicalEducationByTitleLazyQueryHookResult = ReturnType<
	typeof useGetPhysicalEducationByTitleLazyQuery
>
export type GetPhysicalEducationByTitleSuspenseQueryHookResult = ReturnType<
	typeof useGetPhysicalEducationByTitleSuspenseQuery
>
