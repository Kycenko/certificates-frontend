...
export type QueryGetAllStudentsByLastNameArgs = {
...
export type RegisterCuratorMutation = { __typename?: 'Mutation', registerCurator: { __typename?: 'AuthModel', accessToken: string, refreshToken: string, user: { __typename?: 'UserModel', login: string, role: string } } };
...
export type RemoveCuratorMutation = { __typename?: 'Mutation', removeCurator: boolean };
...
export type RemoveManyCuratorsMutation = { __typename?: 'Mutation', removeManyCurators: boolean };
...
export type UpdateCuratorMutation = { __typename?: 'Mutation', updateCurator: { __typename?: 'UserModel', id: string, login: string, role: string } };
...
export type GetGroupByIdQuery = { __typename?: 'Query', getGroupById: { __typename?: 'GroupModel', id: string, title: string, curator?: { __typename?: 'CuratorModel', displayedName: string } | null, students?: Array<{ __typename?: 'StudentModel', id: string, lastName: string, firstName: string, secondName?: string | null, birthDate: any, isExpelled: boolean, certificates?: Array<{ __typename?: 'CertificateModel', id: string, startDate: any, finishDate: any }> | null }> | null, course?: { __typename?: 'CourseModel', id: string, number: string, departmentId: string } | null } };
...
export type GetAllStudentsByLastNameQueryVariables = Exact<{
  lastName: Scalars['String']['input'];
}>;


export type GetAllStudentsByLastNameQuery = { __typename?: 'Query', getAllStudentsByLastName: Array<{ __typename?: 'StudentModel', id: string, lastName: string, firstName: string, secondName?: string | null, group?: { __typename?: 'GroupModel', title: string } | null }> };
...
export type GetStudentByIdQuery = { __typename?: 'Query', getStudentById: { __typename?: 'StudentModel', id: string, lastName: string, firstName: string, secondName?: string | null, birthDate: any, groupId?: string | null, isExpelled: boolean, certificates?: Array<{ __typename?: 'CertificateModel', id: string, startDate: any, finishDate: any, healthGroup: { __typename?: 'HealthGroupModel', title: string }, physicalEducation: { __typename?: 'PhysicalEducationModel', title: string } }> | null, group?: { __typename?: 'GroupModel', id: string, title: string } | null } };
...
export type GetProfileQuery = { __typename?: 'Query', getProfile: { __typename?: 'UserModel', id: string, login: string, role: string } };
...
export const RegisterCuratorDocument = gql`
  ...
  registerCurator(data: $data) {
    ...
    `;
export type RegisterCuratorMutationFn = Apollo.MutationFunction<RegisterCuratorMutation, RegisterCuratorMutationVariables>;
 ...
 * });
 */
export function useRegisterCuratorMutation(baseOptions?: Apollo.MutationHookOptions<RegisterCuratorMutation, RegisterCuratorMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RegisterCuratorMutation, RegisterCuratorMutationVariables>(RegisterCuratorDocument, options);
      }
export type RegisterCuratorMutationHookResult = ReturnType<typeof useRegisterCuratorMutation>;
export type RegisterCuratorMutationResult = Apollo.MutationResult<RegisterCuratorMutation>;
export type RegisterCuratorMutationOptions = Apollo.BaseMutationOptions<RegisterCuratorMutation, RegisterCuratorMutationVariables>;
...
export const RemoveCuratorDocument = gql`
  ...
  removeCurator(id: $id)
    ...
    `;
export type RemoveCuratorMutationFn = Apollo.MutationFunction<RemoveCuratorMutation, RemoveCuratorMutationVariables>;
 ...
 * });
 */
export function useRemoveCuratorMutation(baseOptions?: Apollo.MutationHookOptions<RemoveCuratorMutation, RemoveCuratorMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveCuratorMutation, RemoveCuratorMutationVariables>(RemoveCuratorDocument, options);
      }
export type RemoveCuratorMutationHookResult = ReturnType<typeof useRemoveCuratorMutation>;
export type RemoveCuratorMutationResult = Apollo.MutationResult<RemoveCuratorMutation>;
export type RemoveCuratorMutationOptions = Apollo.BaseMutationOptions<RemoveCuratorMutation, RemoveCuratorMutationVariables>;
export const RemoveManyCuratorsDocument = gql`
    mutation removeManyCurators($ids: [String!]!) {
  removeManyCurators(ids: $ids)
}
    `;
export type RemoveManyCuratorsMutationFn = Apollo.MutationFunction<RemoveManyCuratorsMutation, RemoveManyCuratorsMutationVariables>;
 ...
 * });
 */
export function useRemoveManyCuratorsMutation(baseOptions?: Apollo.MutationHookOptions<RemoveManyCuratorsMutation, RemoveManyCuratorsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveManyCuratorsMutation, RemoveManyCuratorsMutationVariables>(RemoveManyCuratorsDocument, options);
      }
export type RemoveManyCuratorsMutationHookResult = ReturnType<typeof useRemoveManyCuratorsMutation>;
export type RemoveManyCuratorsMutationResult = Apollo.MutationResult<RemoveManyCuratorsMutation>;
export type RemoveManyCuratorsMutationOptions = Apollo.BaseMutationOptions<RemoveManyCuratorsMutation, RemoveManyCuratorsMutationVariables>;
export const UpdateCuratorDocument = gql`
  ...
  updateCurator(id: $id, updateDto: $data) {
    ...
    `;
export type UpdateCuratorMutationFn = Apollo.MutationFunction<UpdateCuratorMutation, UpdateCuratorMutationVariables>;
 ...
 * });
 */
export function useUpdateCuratorMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCuratorMutation, UpdateCuratorMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCuratorMutation, UpdateCuratorMutationVariables>(UpdateCuratorDocument, options);
      }
export type UpdateCuratorMutationHookResult = ReturnType<typeof useUpdateCuratorMutation>;
export type UpdateCuratorMutationResult = Apollo.MutationResult<UpdateCuratorMutation>;
export type UpdateCuratorMutationOptions = Apollo.BaseMutationOptions<UpdateCuratorMutation, UpdateCuratorMutationVariables>;
...
export const GetAllStudentsByLastNameDocument = gql`
    query getAllStudentsByLastName($lastName: String!) {
  getAllStudentsByLastName(lastName: $lastName) {
    id
    lastName
    firstName
    secondName
...
/**
 * __useGetAllStudentsByLastNameQuery__
 *
 * To run a query within a React component, call `useGetAllStudentsByLastNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllStudentsByLastNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllStudentsByLastNameQuery({
 *   variables: {
 *      lastName: // value for 'lastName'
 *   },
 * });
 */
export function useGetAllStudentsByLastNameQuery(baseOptions: Apollo.QueryHookOptions<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables> & ({ variables: GetAllStudentsByLastNameQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>(GetAllStudentsByLastNameDocument, options);
      }
export function useGetAllStudentsByLastNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>(GetAllStudentsByLastNameDocument, options);
        }
export function useGetAllStudentsByLastNameSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>(GetAllStudentsByLastNameDocument, options);
        }
export type GetAllStudentsByLastNameQueryHookResult = ReturnType<typeof useGetAllStudentsByLastNameQuery>;
export type GetAllStudentsByLastNameLazyQueryHookResult = ReturnType<typeof useGetAllStudentsByLastNameLazyQuery>;
export type GetAllStudentsByLastNameSuspenseQueryHookResult = ReturnType<typeof useGetAllStudentsByLastNameSuspenseQuery>;
export type GetAllStudentsByLastNameQueryResult = Apollo.QueryResult<GetAllStudentsByLastNameQuery, GetAllStudentsByLastNameQueryVariables>;
